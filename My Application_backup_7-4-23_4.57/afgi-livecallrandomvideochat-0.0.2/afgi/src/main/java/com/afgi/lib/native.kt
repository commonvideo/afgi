    ...
    if (color.size == 4) {
        ...
        AdLoader.Builder(
            ...
            .forNativeAd { nativeAd ->
                ...
                val adView = layoutInflater
                    .inflate(R.layout.ad_unified_large_home_i, null) as NativeAdView
...
//                btn.setBackgroundResource(color[0])
                ...
                populateUnifiedNativeAdViewLargeHomeI(nativeAd, adView)
                layout?.addView(adView)
                adView.bringToFront()
                layout?.invalidate()
            }
...
fun Activity.requestNativeRecall(
    vararg color: Int,
    placement: String,
    listener: (layout: LinearLayout?, status: String) -> Unit
) {
    if (color.size == 4) {
        ...
        AdLoader.Builder(
            ...
            .forNativeAd { nativeAd ->
                ...
                val adView = layoutInflater
                    .inflate(R.layout.ad_unified_large_recall, null) as NativeAdView
...
//                btn.setBackgroundResource(color[0])
                ...
                populateUnifiedNativeAdViewLargeRecall(nativeAd, adView)
                layout?.addView(adView)
                adView.bringToFront()
                layout?.invalidate()
            }
